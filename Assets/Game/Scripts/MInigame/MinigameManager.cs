    ...
    void Win()
    {
        ...
        switch (minigame_id)
        {
            case 0:
                ...
                GameManagement.instance.AddItemToSchedule_Feed(System.DateTime.Now.AddMinutes(delay).ToString(), current_seal);
                ...
                AndroidService.instance.QueueNotification_Seal(current_seal, notif_types.feed, System.DateTime.Now.AddMinutes(delay).ToString());
                break;
            case 1:
                ...
                GameManagement.instance.AddItemToSchedule_Heal(System.DateTime.Now.AddMinutes(delay).ToString(), current_seal);
                ...
                AndroidService.instance.QueueNotification_Seal(current_seal, notif_types.heal, System.DateTime.Now.AddMinutes(delay).ToString());
                break;
            case 2:
